...
CREATE OR REPLACE PROCEDURE `rj-sms-sandbox.sub_pav_us.proced_4_consultas_emergenciais`()
...
CREATE OR REPLACE TABLE `rj-sms-sandbox.sub_pav_us._consultas_emergenciais` AS
