...
CREATE OR REPLACE PROCEDURE `rj-sms-sandbox.sub_pav_us.proced_3_visitas_acs_gestacao`()
...
CREATE OR REPLACE TABLE `rj-sms-sandbox.sub_pav_us._visitas_acs_gestacao` AS
