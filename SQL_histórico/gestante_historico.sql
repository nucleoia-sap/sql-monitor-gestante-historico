        ...
        SELECT
            *,
            CASE
                ...
                WHEN DATE_ADD(data_inicio, INTERVAL 299 DAY) <= data_referencia THEN DATE_ADD(data_inicio, INTERVAL 299 DAY) -- ALTERADO: era CURRENT_DATE()
        ...
        SELECT
            ...
            CASE
                ...
                AND DATE_ADD(
                    gcs.data_inicio,
                    INTERVAL 299 DAY
                ) > data_referencia THEN 'Gestação' -- ALTERADO: era CURRENT_DATE()
...
-- Adiciona coluna data_referencia para identificar o snapshot
-- ------------------------------------------------------------
SELECT
