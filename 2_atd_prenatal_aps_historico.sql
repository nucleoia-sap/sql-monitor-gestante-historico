...
-- Parâmetro data_referencia: permite gerar snapshot dos atendimentos em uma data específica
CREATE OR REPLACE PROCEDURE `rj-sms-sandbox.sub_pav_us.proced_2_atd_prenatal_aps_historico`(data_referencia DATE)
...
--     config(
--         enabled=true,
--         alias="atendimentos_prenatal_aps_historico",
--     )
-- }}
